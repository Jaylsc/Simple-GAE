        ...
        <div class="container-fluid">
          ...
          <div class="nav-collapse collapse">
            <p class="navbar-text pull-right">
              <a href="logout.php" target="_self" class="navbar-link">Logout</a>
            </p>
            <ul class="nav">
                
                <li><a target="_self" href="#">Home</a></li>
               <li><a target="_self" href="#">Reserve</a></li>
      ...
      <div class="row-fluid">
        <div class="span2">
			...
			<div class="accordion" id="accordion_menu">
                            ...
                            <li><a href="adminhistory.php" target="frame">Hisory1</a></li>
                            <li><a href="adminhistory2.php" target="frame">History2</a></li>
            ...
            <div class="span12">
				...
				<div class="tab-content" id="grid-demo-tabs-content">
					...
					<div id="demo" class="tab-pane fade in active">
						...
						<iframe onload="iframeLoaded(this)" name="frame" frameborder="0" width="100%" height="500" src="adminhistory.php"></iframe>
					</div>
			...
			<div class="span12">
			  <div class="row-fluid">
				<div class="alert alert-info">
					<a name="contact"></a>
                                        <p><a href="adminhistory.php">DEMO</a> <?php echo date("Y") , date("M") , date("d");?></p>
				</div><!--/span-->
			  </div><!--/row-->
			</div><!--/span-->
		  </div><!--/row-->
